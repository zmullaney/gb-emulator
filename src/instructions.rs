...
impl Instruction {
    ...
    fn from_byte_prefixed(byte: u8) -> Option<Instruction> {
        match byte {
            ...
            // RES 0
            0x80 => Some(Instruction::RES(0, ArithmeticTarget::B)),
            0x81 => Some(Instruction::RES(0, ArithmeticTarget::C)),
            0x82 => Some(Instruction::RES(0, ArithmeticTarget::D)),
            0x83 => Some(Instruction::RES(0, ArithmeticTarget::E)),
            0x84 => Some(Instruction::RES(0, ArithmeticTarget::H)),
            0x85 => Some(Instruction::RES(0, ArithmeticTarget::L)),
            0x86 => Some(Instruction::RES(0, ArithmeticTarget::HL)),
            0x87 => Some(Instruction::RES(0, ArithmeticTarget::A)),
            // RES 1
            0x88 => Some(Instruction::RES(1, ArithmeticTarget::B)),
            0x89 => Some(Instruction::RES(1, ArithmeticTarget::C)),
            0x8A => Some(Instruction::RES(1, ArithmeticTarget::D)),
            0x8B => Some(Instruction::RES(1, ArithmeticTarget::E)),
            0x8C => Some(Instruction::RES(1, ArithmeticTarget::H)),
            0x8D => Some(Instruction::RES(1, ArithmeticTarget::L)),
            0x8E => Some(Instruction::RES(1, ArithmeticTarget::HL)),
            0x8F => Some(Instruction::RES(1, ArithmeticTarget::A)),
            // RES 2
            0x90 => Some(Instruction::RES(2, ArithmeticTarget::B)),
            0x91 => Some(Instruction::RES(2, ArithmeticTarget::C)),
            0x92 => Some(Instruction::RES(2, ArithmeticTarget::D)),
            0x93 => Some(Instruction::RES(2, ArithmeticTarget::E)),
            0x94 => Some(Instruction::RES(2, ArithmeticTarget::H)),
            0x95 => Some(Instruction::RES(2, ArithmeticTarget::L)),
            0x96 => Some(Instruction::RES(2, ArithmeticTarget::HL)),
            0x97 => Some(Instruction::RES(2, ArithmeticTarget::A)),
            // RES 3
            0x98 => Some(Instruction::RES(3, ArithmeticTarget::B)),
            0x99 => Some(Instruction::RES(3, ArithmeticTarget::C)),
            0x9A => Some(Instruction::RES(3, ArithmeticTarget::D)),
            0x9B => Some(Instruction::RES(3, ArithmeticTarget::E)),
            0x9C => Some(Instruction::RES(3, ArithmeticTarget::H)),
            0x9D => Some(Instruction::RES(3, ArithmeticTarget::L)),
            0x9E => Some(Instruction::RES(3, ArithmeticTarget::HL)),
            0x9F => Some(Instruction::RES(3, ArithmeticTarget::A)),
            // RES 4
            0xA0 => Some(Instruction::RES(4, ArithmeticTarget::B)),
            0xA1 => Some(Instruction::RES(4, ArithmeticTarget::C)),
            0xA2 => Some(Instruction::RES(4, ArithmeticTarget::D)),
            0xA3 => Some(Instruction::RES(4, ArithmeticTarget::E)),
            0xA4 => Some(Instruction::RES(4, ArithmeticTarget::H)),
            0xA5 => Some(Instruction::RES(4, ArithmeticTarget::L)),
            0xA6 => Some(Instruction::RES(4, ArithmeticTarget::HL)),
            0xA7 => Some(Instruction::RES(4, ArithmeticTarget::A)),
            // RES 5
            0xA8 => Some(Instruction::RES(5, ArithmeticTarget::B)),
            0xA9 => Some(Instruction::RES(5, ArithmeticTarget::C)),
            0xAA => Some(Instruction::RES(5, ArithmeticTarget::D)),
            0xAB => Some(Instruction::RES(5, ArithmeticTarget::E)),
            0xAC => Some(Instruction::RES(5, ArithmeticTarget::H)),
            0xAD => Some(Instruction::RES(5, ArithmeticTarget::L)),
            0xAE => Some(Instruction::RES(5, ArithmeticTarget::HL)),
            0xAF => Some(Instruction::RES(5, ArithmeticTarget::A)),
            // RES 6
            0xB0 => Some(Instruction::RES(6, ArithmeticTarget::B)),
            0xB1 => Some(Instruction::RES(6, ArithmeticTarget::C)),
            0xB2 => Some(Instruction::RES(6, ArithmeticTarget::D)),
            0xB3 => Some(Instruction::RES(6, ArithmeticTarget::E)),
            0xB4 => Some(Instruction::RES(6, ArithmeticTarget::H)),
            0xB5 => Some(Instruction::RES(6, ArithmeticTarget::L)),
            0xB6 => Some(Instruction::RES(6, ArithmeticTarget::HL)),
            0xB7 => Some(Instruction::RES(6, ArithmeticTarget::A)),
            // RES 7
            0xB8 => Some(Instruction::RES(7, ArithmeticTarget::B)),
            0xB9 => Some(Instruction::RES(7, ArithmeticTarget::C)),
            0xBA => Some(Instruction::RES(7, ArithmeticTarget::D)),
            0xBB => Some(Instruction::RES(7, ArithmeticTarget::E)),
            0xBC => Some(Instruction::RES(7, ArithmeticTarget::H)),
            0xBD => Some(Instruction::RES(7, ArithmeticTarget::L)),
            0xBE => Some(Instruction::RES(7, ArithmeticTarget::HL)),
            0xBF => Some(Instruction::RES(7, ArithmeticTarget::A)),
            // SET 0
